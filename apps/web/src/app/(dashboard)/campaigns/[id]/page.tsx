    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <div className="flex items-center gap-3">
            <Badge variant="outline">{campaign.platform.replace("_", " ")}</Badge>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Campaign creation and deployment timeline</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>Daily metrics and trends</CardDescription>
        </CardHeader>
        <CardContent>
