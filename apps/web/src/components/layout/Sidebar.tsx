...
const BeakerIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5a2.25 2.25 0 0 0-.659 1.591v3.04a2.25 2.25 0 0 0 2.25 2.25h4.815c.21 0 .413-.07.574-.198l4.903-3.902c.161-.128.25-.322.25-.526 0-.21-.092-.414-.259-.549L13.25 14.5V8.818a2.25 2.25 0 0 1 .659-1.591l2.81-2.81A2.25 2.25 0 0 0 18.31 2.25H9.75V3.104Z" />
  </svg>
);
...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const navigation: NavigationItem[] = [
    ...
    ...item,
    current: pathname === item.href || (item.href === '/ppc' && pathname.startsWith('/ppc')),
  }));
